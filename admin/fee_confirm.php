	...
	<body>
		...
		<?php
			...
			{	
				...
				<?php $img = $arr['image'];?>
				<td><?php echo $arr['fee_paid']?></td>
				<td style="width: 370px;"><div class="image-wrapper">
					<img src='../Userimg/<?php echo $img; ?>' alt='Bank Slip'/>
					</div></td>
				<td><a href="<?php echo '../Database/admin_confirm.php?exam_roll='.$roll;?>">Confirm</a></td>
